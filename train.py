...
if __name__ == '__main__':
    x_train_savepath = 'x_train_generate.npy'
    y_train_savepath = 'y_train_generate.npy'
    save_weight_path = './checkpointResNet18/ResNet18.ckpt'
    out_put_path = './Ouput'
    train(x_train_savepath, y_train_savepath, save_weight_path, out_put_path, batch_size=8, epochs=300,
          use_data_enhance=True, use_generate_picture=True)
